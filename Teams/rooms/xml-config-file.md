...
|\<PasswordRotationEnabled> |Boolean &#x2777;  |First &#x2776;  |Disabled by default. |
|\<PasswordUpdateFrequencyInDays> |Integer;  |First &#x2776;  |Sets frequency of password rotation in days. Acceptable values include: 2, 30, 60, and 90. If value provided is not one of the acceptable values, then the field is not updated. |
