...
|\<PasswordUpdateFrequencyInDays> |Integer;  |First &#x2776;  |Sets frequency of password rotation in days. Acceptable values include: 2, 30, 60, and 90. Otherwise value is not updated. |
